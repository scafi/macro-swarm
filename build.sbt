...
lazy val alchemist = project
  ...
  .settings(
    ...
    libraryDependencies += "it.unibo.alchemist" % "alchemist-incarnation-scafi" % "42.3.32",
    libraryDependencies += "it.unibo.alchemist" % "alchemist-swingui" % "42.3.32"
  )
