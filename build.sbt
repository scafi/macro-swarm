...
lazy val core = project.settings(
  ...
  scalaVersion := defaultScalaVersion,
  libraryDependencies += "it.unibo.scafi" %% "scafi-core" % "1.6.0"
)
...
lazy val alchemist = project
  ...
  .settings(
    ...
    libraryDependencies += "it.unibo.alchemist" % "alchemist-incarnation-scafi" % "43.0.14",
    libraryDependencies += "it.unibo.alchemist" % "alchemist-swingui" % "43.0.14"
  )
