...
lazy val alchemist = project
  ...
  .settings(
    ...
    libraryDependencies += "it.unibo.alchemist" % "alchemist-incarnation-scafi" % "43.0.46",
    libraryDependencies += "it.unibo.alchemist" % "alchemist-swingui" % "43.0.46"
  )
